/*! @license DOMPurify 3.0.1 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.0.1/LICENSE */ !(function(
    ...
    function o(e, t) {
        return (
            ...
            (function(e, t) {
                ...
                try {
                    for (
                        n = n.call(e); !(i = (r = n.next()).done) &&
                        (a.push(r.value), !t || a.length !== t); i = !0
                    );
                } catch (e) {
                    (l = !0), (o = e);
                } finally {
    ...
    function R(e) {
        return function(t) {
            for (
                var n = arguments.length, r = new Array(n > 1 ? n - 1 : 0), o = 1; o < n; o++
            )
                r[o - 1] = arguments[o];
            return g(e, t, r);
        };
    ...
    var re = (function t() {
        ...
        if (
            ((r.version = '3.0.1'),
                (r.removed = []), !n || !n.document || 9 !== n.document.nodeType)
        )
        ...
        var ye,
            ...
            dt = function(t) {
                ...
                ((t && 'object' === e(t)) || (t = {}),
                    ...
                    Ve &&
                    ((_e = C({}, a(P))),
                        (ke = []), !0 === Ve.html && (C(_e, I), C(ke, B)), !0 === Ve.svg && (C(_e, U), C(ke, G), C(ke, q)), !0 === Ve.svgFilters && (C(_e, F), C(ke, G), C(ke, q)), !0 === Ve.mathMl && (C(_e, H), C(ke, W), C(ke, q))),
        ...
        var Tt = function(e) {
                    ...
                    (Fe &&
                        ...
                        ((t = e.textContent),
                            ...
                            (A(r.removed, {
                                ...
                                (e.textContent = t))),
                        xt('afterSanitizeElements', e, null), !1) :
                    (Nt(e), !0);
            },
            Ot = function(e, t, n) {
                    ...
                    for (i = l.length; i--;) {
                        ...
                        if (
                            ((o = 'value' === s ? n.value : k(n.value)),
                                ...
                                (o = c.attrValue), !c.forceKeepAttr && (At(s, t), c.keepAttr))
                        )
                            if (Ue || !O(/\/>/i, o)) {
                                Fe &&
                                    ((o = _(o, be, ' ')),
            ...
            Ct = function e(t) {
                var n,
                    r = wt(t);
                for (xt('beforeSanitizeShadowDOM', t, null);
                    (n = r.nextNode());)
